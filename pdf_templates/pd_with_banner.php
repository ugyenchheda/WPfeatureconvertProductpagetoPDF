...
.textImport {
  ...
  <body>  
    <div style="top:150px;width:100%; text-align:center;">
      <img style="width:300px" src="http://newpalmer.indexportal.no/wp-content/uploads/2019/10/palmerwine.png">
    </div> 
    <div style="padding-top:80px; margin-left: -60px; margin-right: -60px;">
      <?php $image_url123 = 'http://newpalmer.indexportal.no/wp-content/uploads/2019/11/Palmer-Smaks-skjema-1.jpg';
        if($_POST['imgpth']):
          $image_url123 = $_POST['imgpth'];
        endif;
      ?>
      <img style="position: absolute; width: 100%;" src="<?php echo $image_url123;?>">
    </div> 
      <div class="site-content" role="main">
        <div class="container">
          <p class="textImport" style="margin-bottom: 300px;"><?php echo $_POST['text']; ?></p>
        </div>
      </div>    
    <div class="site-content" role="main">
  <div class="container">
...
<div class="site-logo">
  <img style="margin-top: 50px;" src="<?php echo str_replace( 'https://', 'http://', $data['first_parent_image']);?>" width="150px" />
</div>
<div class="clear"></div>
<!-------------------  top section  -------->
<div class="top-part">
  ...
  <div class="porduct-info">
    <div class="product-logo">
      ...
      <?php if(isset($data['category_image']) && !empty($data['category_image'])):?>
        <img src="<?php echo str_replace( 'https://', 'http://', $data['category_image']);?>" height="180px"/>
      <?php endif;  ?> 
    </div>
        <div class="attr">
          <div class="attr_left">
    ...
    <div class="icon-part">
      <div class="attr_left">
        ...
        <div class="attr-list">
          <p><span class="topTxt">Friskhet Test here</span></p>
