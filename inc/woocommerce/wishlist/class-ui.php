	...
	public function add_to_wishlist_btn( $classes = '', $link_classes = '' ) {
		?>
			<div class="<?php echo esc_attr( $classes ); ?>">
				<a id="gdfav_id<?php echo $val->ID ?>" class="<?php echo esc_attr( $link_classes ); ?>" href="<?php echo esc_url( basel_get_whishlist_page_url() ); ?>" data-key="<?php echo esc_attr( wp_create_nonce( 'basel-wishlist-add' ) ); ?>" data-product-id="<?php echo esc_attr( get_the_ID() ); ?>" data-added-text="<?php esc_html_e( 'Browse Wishlist', 'basel' ); ?>"><?php esc_html_e( 'Legg til i ønskeliste', 'basel' ); ?></a>
			</div>
		<?php
	}
